...
public class Demo {
	...
	public static void main(String[] args) {
		...
		//
		System.out.println("bdika p4");
		System.out.println(person4.getName());
		System.out.println(person4.getPhone());
		System.out.println(person3.equals(person4));
		
		Person person5 = new Person(name4, phone2);
		...
		System.out.println(distributionList.contains(person3)); 
		...
		System.out.println("bdika add");
		System.out.println(distributionList.add(person4));
		System.out.println(distributionList.add(person5));
	...
	System.out.println(distributionList.getIfNumberHasASequenceOfDigits("76")); // DistributionList
	// [persons={(Person [name=Adam
	// Levi, phone=(05)7654-321])(Person
	// [name=Hava Choen,
	// phone=(08)3217-654])}]
